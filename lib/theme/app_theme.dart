...
/// Implements Contemporary Persian Minimalism design with Focused Learning Palette
class AppTheme {
  AppTheme._();

  // Color specifications based on design requirements
  static const Color primaryLight = Color(0xFF2E7D5A); // Deep forest green
  static const Color primaryVariantLight = Color(0xFF1F5A3F); // Darker variant
  static const Color secondaryLight = Color(0xFFF4A261); // Warm amber
  static const Color secondaryVariantLight = Color(0xFFE8956A); // Darker amber
  static const Color backgroundLight = Color(0xFFFAFAFA); // Soft off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight = Color(0xFFE76F51); // Muted coral
  ...
  static const Color textPrimaryLight = Color(0xFF2D3748); // Dark charcoal
  static const Color textSecondaryLight = Color(0xFF718096); // Medium gray
  static const Color dividerLight = Color(0xFFE2E8F0); // Subtle gray

  // Dark theme colors (adapted for night mode)
  static const Color primaryDark =
      Color(0xFF52B788); // Lighter green for dark mode
  static const Color primaryVariantDark = Color(0xFF2E7D5A); // Original primary
  static const Color secondaryDark = Color(0xFFF4A261); // Same amber
  static const Color secondaryVariantDark = Color(0xFFE8956A); // Darker amber
  ...
  static const Color errorDark = Color(0xFFE76F51); // Same coral
  static const Color successDark = Color(0xFF52B788); // Same green
  static const Color warningDark = Color(0xFFF9C74F); // Same yellow
  ...
  static const Color dividerDark = Color(0xFF4A5568); // Dark divider

  // Shadow colors for subtle elevation
  static const Color shadowLight =
      Color(0x14000000); // 8% opacity for 2-4dp blur
  static const Color shadowDark =
      Color(0x1FFFFFFF); // Light shadow for dark theme

  /// Light theme with Contemporary Persian Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for contextual action modes
    ...
    // Card theme for progressive disclosure cards
    cardTheme: CardTheme(
      color: surfaceLight,
      elevation: 2.0,
      shadowColor: shadowLight,
    ...
    // Bottom navigation for adaptive RTL navigation
    ...
    // FloatingActionButton for voice input integration
    ...
    // Text theme with Persian-optimized fonts
  ...
  /// Dark theme with Contemporary Persian Minimalism
  ...
  static const Color info = Color(0xFF3182CE); // Blue for information

  /// Shadow configurations for subtle elevation
